...
Que tal tentar baixar o banco de candidatos? Para isso, acesse esse [link](http://agencia.tse.jus.br/estatistica/sead/odsele/consulta_cand/consulta_cand_2018.zip) e faça o download do banco de candidatos. O arquivo baixado vem no formato __zip__ e contém os candidatos separados por Unidade Federativa.

No caso, vamos nos ater ao `consulta_cand_2018_SP.csv` com os candidatos de São Paulo
...
3. No R temos, bancos para fins didáticos. Para utilizá-los basta usar a função data. Para esse exercícios utilizaremos o banco mtcars. Execute `data(mtcars)`.
...
| Banco  | Link     |
|--------|----------|
| Candidatos das Eleições de 2018 | [Download](http://agencia.tse.jus.br/estatistica/sead/odsele/consulta_cand/consulta_cand_2018.zip)
